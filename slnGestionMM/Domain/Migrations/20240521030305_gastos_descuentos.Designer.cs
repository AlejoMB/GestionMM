...
namespace Domain.Migrations
{
    ...
    [Migration("20240521030305_gastos_descuentos")]
    partial class gastos_descuentos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Facturacion.RangoDescuentos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Gastos.Gastos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Gastos.TipoGastos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "051d33fe-8d04-47cf-b069-644b4425f688",
                            Email = "alejo0921@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "alejo0921@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEMFMpHaIOgts4JXbCpdWFCMaihCeEFHd0kNi1yJ52xzNoL17QvMUoCgfh+MpbWb52w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ca771903-e247-437e-96cc-06981f2398a7",
            ...
            modelBuilder.Entity("Domain.Entities.Gastos.Gastos", b =>
                {
                    b.HasOne("Domain.Entities.Gastos.TipoGastos", "TipoGasto")
                        .WithMany("Gastos")
